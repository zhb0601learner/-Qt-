...
private:
    ...
    char* photo[2]={"://image/underground/pekinguniveastgate/Platform_of_Peking_Univ._East_Gate_Station_(20210202165908).jpg"
                    ,"://image/underground/pekinguniveastgate/moasic_of_pekinguniveastgate.jpg"};
    int index=0;
};
